...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/emmet-vim,~/.vim/bundle/The-NERD-Commenter,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/emmet-vim/after,~/.vim/bundle/The-NERD-Commenter/after
set shiftwidth=4
set smarttab
set softtabstop=4
